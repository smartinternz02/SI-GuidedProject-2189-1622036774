...
API_KEY = "DkEe2ESTP9gN3Ofw7kvlLoLaCuJoX_xo2PYFXdKMiayR"
...
response_scoring = requests.post('https://us-south.ml.cloud.ibm.com/ml/v4/deployments/ae5e2fb8-609b-4e1c-bfa5-67b7dd6d25ab/predictions?version=2021-06-10', json=payload_scoring, headers={'Authorization': 'Bearer ' + mltoken})
